...
<body>
        ...
        <section id="adm_spc_panel">
            <div id="adm_spc_list">
                ...
                <section id="spc_search_add">
                    ...
                    <a href="panel_crear_products.php"class="botones btn_add">Añadir</a>
                </section>
                ...
                <section id="space_table">
                    <table>
                        ...
                        <tbody id="spc_product_new">
                            <?php
                                include('../php/get_products_admin.php')
                            ?>
                        </tbody>
                    </table>
    ...
    <script src="js/añadir_product_new.js"></script>
</body>
</html>