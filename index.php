...
<div class="page-wrapper">
    ...
    <header class="main-header header-style-two">
				...
				<div>
					<div col-md-12="" col-xs-12="">
						<div class="container-fluid" id="cinti">
							<img src="images/cintillotop.jpg" width="1800" alt="cintillo">
						</div>
					</div>
			...
			<div class="auto-container">
				<div class="inner-container d-flex justify-content-between align-items-center">
					...
					<div class="logo-box d-flex">
						<div class="logo"><a href="index.php"><img src="images/lab_mir/logo1.png" alt="" title=""></a></div>
					</div>
						...
						<nav class="main-menu show navbar-expand-md">
							...
							<div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
								<ul class="navigation clearfix">
									...
									<li><a href="#map-one"><img src="images/icons/usuario-de-perfil.png" alt="" id="imgcontacto">¡Contáctanos!</a></li>
								</ul>
							</div>
						</nav>
						<!-- Main Menu End-->
        ...
        <div class="sticky-header">
            <div class="auto-container">
				<div class="d-flex justify-content-between align-items-center">
					<!-- Logo -->
					<div class="logo">
						<a href="index.php" title=""><img src="images/lab_mir/logo1.png" width="120" alt="" title=""></a>
					</div>
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="index.php"><img src="images/lab_mir/logo1.png" alt="" title=""></a></div>
	...
	<section class="slider-two">
		...
		<div class="single-item-carousel owl-carousel owl-theme">
			<!-- Slide -->
			<div class="slide">
				<div class="slider-two_image-layer" style="background-image: url(images/main-slider/slider1.jpg)"></div>
				<div class="auto-container">
					<!-- Slider One Title Column -->
					<div class="slider-two_title-column">
						<div class="slider-two_title-inner">							
							<h1 class="slider-two_heading">SOLUCIONES   QUE DAN VIDA </h1>
							<div class="slider-two_text">FORTALECIENDO LA PRODUCCIÓN NACIONAL</div>
							<!-- Button Box -->
						</div>
					</div>
				</div>
			...
			<!-- Slide -->
			<div class="slide">
				<div class="slider-two_image-layer" style="background-image: url(images/main-slider/slider2.jpg)"></div>
					<div class="auto-container">
						<!-- Slider One Title Column -->
						<div class="slider-two_title-column">
							<div class="slider-two_title-inner">		
	...
	<section class="gallery-one">
		<div class="outer-container">
			<div class="gallery-carousel owl-carousel owl-theme">
				<?php
					include('php/getCarruselNews.php')
				?>
			</div>
		</div>	
	</section>
	...
	<section class="faq-one style-three">
		<div class="auto-container">
			<div class="row clearfix">
				...
				<!-- Content Column -->
				<div class="faq-one_content-column col-lg-8 col-md-12 col-sm-12">
					<div class="faq-one_content-inner">
						<!-- Sec Title -->
					
							
							<h1 class="texto_titulo_seccion">QUIENES SOMOS</h1>
                            <div class="sec-title_separator"></div>
							<div class="sec-title_text" style="width: 760px">Laboratorios Miranda nace el 1 de abril de 2013 en aras de lograr soberanía potenciado el desarrollo científico tecnológico, social e industrial del Estado Venezolano en el área de salud, centrando su filosofía de gestión en <b>elaborar y comercializar</b> productos de uso hospitalario con los más altos estándares de <b>calida, eficiencia y confiabilidad</b> en la elaboración de soluciones que dan vida proyectando cubrir necesidades esenciales nacionales e internacionales.    
                            </div>
					</div>
				</div>

				<!-- Image Column -->
				<div class="faq-one_image-column col-lg-4 col-md-12 col-sm-12">
					<div class="faq-one_image-inner parallax-scene-5">
						<div class="faq-one_image-two" data-depth="0.20">
							<img src="images/lab_mir/quienes_somos.jpeg" alt="" />
						</div>
					</div> 
				</div>
			</div>
			...
			<div class="container" style="margin-top: 80px;">
				<h1 class="texto_titulo_seccion">VALORES</h1>
				<div class="sec-title_separator"></div>
			</div> 
		</div>
	...
	<div>                
		<img src="images/lab_mir/valores.png" width="1200"/>
	</div>
        ...
        <div class="auto-container">
			<div class="sponsors-outer">
				...
				<ul class="sponsors-carousel owl-carousel owl-theme">
					...
					<li class="slide-item"><figure class="image-box"><a                  href="index.php">                         <img src="images/lab_mir/empresas/4.png" style="width: 120px; height: 120px;" alt=""></a></figure></li>
...
<br>
	<div class="auto-container">
		<!-- Sec Title -->
		<div class="sec-title centered">
			<div class="sec-title_title">LABORATORIOS MIRANDA, C.A.</div>
			<h2 class="sec-title_heading">CONTÁCTANOS</h2>
			<div class="sec-title_separator"></div>
		</div>
	</div>
				...
				<ul class="map-one_info">
					<li>
						<a target="_blank" href="https://maps.app.goo.gl/rk1Kzp1T7mUnoLH8A">
							 ...
							 <h5 style="text-align: center;"><b>Los Naranjos, Guarenas, Edo. Miranda</b></h5></a>
						<p style="text-align: center;"> Zona Industrial, Av. Maturín, Manzana 6, Parcela 8,9 y 10.</p>
					</li>
    ...
    <footer class="main-footer">
		...
		<div class="footer-copyright">
			<div class="auto-container">
				<div class="copyright"><a href="index.php">Laboratorios Miranda C.A</a> &copy; Copyright-2023 All Rights Reserved.</div>
			</div>
		</div>
	</footer>
	<!-- End Main Footer -->
